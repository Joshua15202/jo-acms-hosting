...
import { ArrowUpRight, TrendingUp, ShoppingCart, Calendar, AlertTriangle, BarChart } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500">Optimize inventory, forecast demand, and get smart reordering recommendations</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-rose-600 hover:bg-rose-700">Update Forecasts</Button>
        </div>
      </div>
